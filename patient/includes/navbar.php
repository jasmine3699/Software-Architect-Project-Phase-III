...
<nav style="background-color: #DDDDDD;">
    ...
    <div class="nav-links">
        ...
        <a class="nav-link <?php echo ($filename == 'patient-report.php') ? 'active' : ''; ?>" href="patient-report.php">Report</a>
    </div>
    <div class="profile">
        <span class="prof-img"><img src="../assets/img/pat-profile.png" alt="" width="30"></span>
