        ...
        <div class="login-card dr-login-bg">
            ...
            <form class="login-form" action="auth.php" method="POST">
                ...
                <div class="login-form-button">
                    <button class="btn-secondary" type="submit" name="doctor-login">Login</button>
                </div>
            </form><br>
            <a style="text-decoration: none; color: black; margin-left:15px;" href="register.php">Register New Doctor</a>
        </div>
    </div>
